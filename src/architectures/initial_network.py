...
class InitialNetwork(Model):
    def __init__(self, channels):
        ...
        self.outputs_2 = deeplearning_blocks.CNNLayer(1, activation='linear',use_bias=True, use_batch_norm=False)
    ...
    def get_config(self):
        config = super(InitialNetwork, self).get_config()
        config.update({
...
if __name__ == "__main__":
    ...
    dot_img_file = "..." # path for storing the plot
    channels = [64,128,256,512,1024]
    Model = InitialNetwork(channels)
